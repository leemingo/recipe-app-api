...
def sample_tag(user, name = 'Main course'):
    '''Create and reaturn a sample tag'''
    return Tag.objects.create(user = user, name = name)

def sample_ingredients(user, name = 'Cinnamon'):
    '''Create and return a sampe ingredients'''
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        '''Test returning recipes specific tags'''
        recipe1 = sample_recipe(user = self.user, title = 'Thai_vegetable_curry')
